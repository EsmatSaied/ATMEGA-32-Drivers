...
/*3mlna el macro da hna m4 fl config. 34an da mtsdr ll user de 7aga hwa hyst5dmha w yb3tha
 * l fn k argument msh 7aga config. l tazbet el m.c*/
...
#define LCD_u8_TWELVTH_COLUMN		11
#define LCD_u8_THIRTEENTH_COLUMN	12
#define LCD_u8_FOURTEENTH_COLUMN	13
#define LCD_u8_FIFTEETH_COLUMN		14
#define LCD_u8_SIXTEETH_COLUMN		15
...
void LCD_voidWriteString(char const * Copy_pchString); /*const isn't mandatory but it's E.S rule,
b2kd eny msh h8yr fl string da 5als*/
